...
FFMPEG_SUBSLOT=57.48.101

#SCM=""
inherit git-2 versionator
if [ "${PV#9999}" != "${PV}" ] ; then
#	SCM="git-r3"
	EGIT_REPO_URI="git://github.com/zillevdr/FFmpeg.git"
#	EGIT_BRANCH="rockchip-new"
#	EGIT_REPO_URI="git://github.com/LongChair/FFmpeg.git"
	EGIT_BRANCH="rockchip"
fi
